/**
 * Icon — a single, dependency-free SVG icon system.
 * Stroke icons in the Lucide visual style. Add new icons to PATHS.
 */
...
const PATHS = {
  ...
  quote: <><path d="M3 21c3 0 7-1 7-8V5H3v8h4" /><path d="M14 21c3 0 7-1 7-8V5h-7v8h4" /></>,
  ...
  // industries
  bank: <><path d="M3 21h18" /><path d="M5 21V10M19 21V10M9 21V10M15 21V10" /><path d="m12 2 9 5H3l9-5z" /></>,
  heart: <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" />,
  cart: <><circle cx="8" cy="21" r="1" /><circle cx="19" cy="21" r="1" /><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12" /></>,
  factory: <><path d="M2 20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8l-7 5V8l-7 5V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2z" /><path d="M6 18h.01M10 18h.01M14 18h.01" /></>,
  ...
  partner: <><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="m17 11 2 2 4-4" /></>,
};

export default function Icon({ name, size = 24, className = "", strokeWidth = 1.7, ...props }) {
